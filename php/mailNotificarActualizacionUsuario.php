...
<head>
    ...
    <meta charset="UTF-8">
    <title>Notificación Actualización Cuenta Usuario | BioUrbis</title>
    <!--Logotipo pestaña-->
...
<body>
    <?php
        ...
        //Recuperar correo y nombre completo del administrador
        $correoAdmin=$datosAdmin["usuCorreo"];
        ...
        try {
            ...
            $mail->Subject = 'BioUrbis-Notificación de Actualización Cuenta BioUrbis';
            $mail->Body    = 
                    ...
                    <td>
                        <div style='color:#34495e; margin: 4% 10% 2%; text-align: justify; font-family: Montserrat;'>
                            ...
                            <div style='color:black;'> 
                                <p> Le informamos que un administrador de la plataforma BioUrbis realizó modificaciones en los datos asociados a su cuenta </p>
                            </div>

                            <div style='color:black; font-size: 16px;'> 
                                <p><strong>Administrador:</strong> $nombreAdmin</p> 
                                <p><strong>Fecha de actualización:</strong> $fechaActual</p> 
                                <p><strong>Documento:</strong> $usuarioActivo</p> 
                                <p style='margin-top:15px;'> Si reconoce esta actualización no es necesario realizar ninguna acción. En caso de que no esté de acuerdo con los cambios realizados o considere que existe algún error, comuníquese con el administrador o con el equipo de soporte. </p> 
                            </div>
