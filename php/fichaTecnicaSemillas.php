<?php
  ...
  $existeSemilla=consultarExistenciaSemilla($idSemilla);
  ...
  if($existeSemilla){
    ...
    $datosEtapaCrecimiento=consultarEtapaCrecimientoSemilla($idEtapaCrecimiento);
...
<body>
    <div class="ficha-container">
        ...
        <div class="content">
            <!-- Imagen en esquina superior derecha -->
              <div class="image-corner">
                    <img src="../images/semillas/img_<?php echo $datosSemilla["semImagen"]?>" 
        ...
        <div class="observaciones-section">
            <div class="observaciones-box" contenteditable="true" placeholder="Escribe observaciones aquí…">
