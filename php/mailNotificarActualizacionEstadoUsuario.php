...
<head>
    ...
    <meta charset="UTF-8">
    <title>Notificación Modificación Estado Cuenta Usuario | BioUrbis</title>
    <!--Logotipo pestaña-->
...
<body>
    <?php
        ...
        try {
            ...
            $mail->Subject = 'BioUrbis-Notificación de Modificación Estado Cuenta BioUrbis';
            $mail->Body    = 
                    ...
                    <td>
                        <div style='color:#34495e; margin: 4% 10% 2%; text-align: justify; font-family: Montserrat;'>
                            ...
                            <div style='color:black;'> 
                                <p> Le informamos que un administrador de la plataforma BioUrbis modificó el estado de su cuenta registrada </p>
                            </div>
                            ...
                            <div style='color:black; font-size: 16px;'> 
                                ...
                                <p style='margin-top:15px;'> Si reconoce esta modificación no es necesario realizar ninguna acción. En caso de que no esté de acuerdo con los cambios realizados o considere que existe algún error, comuníquese con el administrador o con el equipo de soporte. </p> 
                            </div>
