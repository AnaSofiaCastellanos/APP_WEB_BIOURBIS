...
<?php
    ...
    if(isset($_POST["guardarCambiosBtn"])){
        ...
        if($datosUsuario["usuEstadoCorreo"]==="Verificado"){
            ...
            if($nombreCompleto!=""){
                $_SESSION["nuevoNombreCompleto"]=$nombreCompleto;
            }else{
                $_SESSION["nuevoNombreCompleto"]=$datosUsuario["usuNombre"];
            }
            ...
            if($barrio!=""){
                $_SESSION["nuevoBarrio"]=$barrio;
            }else{
                $_SESSION["nuevoBarrio"]=$datosUsuario["usuBarrio"];
            }
        
            //Actualizar la contraseña del usuario
            if($contrasena!=""){
                //Encriptar la contraseña
                $_SESSION["nuevaContrasena"]=md5($contrasena);
            }else{
                $_SESSION["nuevaContrasena"]=$datosUsuario["usuContrasena"];
            }
