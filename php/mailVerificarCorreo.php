    ...
    <?php        
        ...
        if (isset($_POST["codigoVerificacion"])){ 
            ...
            try {
                ...
                $mail->Subject = 'BioUrbis-Verificación de cuenta';
                $mail->Body    = 
                        ...
                        <td>
                            <div style=' color:#34495e; margin: 4% 10% 2%; text-align: justify; font-family: 'Montserrat';'>
                                ...
                                <p style='margin: 2px; font-size: 20px;'>
                                    ...
                                    <div style='color:black;'>Le damos la bienvenida a BioUrbis. Gracias por registrarse
                                    en nuestra plataforma, para verificar su cuenta, ingrese el siguiente código
                                    de verificación:</div>
