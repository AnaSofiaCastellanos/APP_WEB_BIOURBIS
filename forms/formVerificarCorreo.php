...
<body>
    <?php 
        ...
        if(isset($_POST["botonVerificar"])){
            ...
            $codVerificacionUsuario=trim($_POST["codVerificacion"]);
            ...
            if($codVerificacionUsuario==$codVerificacion){ 
                ...
                if(actualizarEstadoCorreo($numeroDocumento)){
                    //Ejecutar mensaje cuando se actualizó el estado del correo
                    $_SESSION["alerta"]="verificacionExitosa";

                    //Registrar la actividad del usuario
                    registrarActividadUsuario("Usuario","Verificar","Usuario ha verificado su correo electrónico", $numeroDocumento);
    ...
    <div class="container-Verificar-Correo">
        <div class="container-form">
            <form action="../forms/formVerificarCorreo.php" class="sign-in"  id="formularioVerificarCorreo" method="POST">
                ...
                <div class="verification-container">
                    ...
                    <input
                        ...
                        id="codVerificacionVerificarCorreo">
                </div>
                <p id="errorCodigoVerificacionVerificarCorreo" class="error-message"></p>
                ...
                case 'verificacionExitosa': ?>
                    <script>
                        ...
                        mostrarMensaje({
                            ...
                            text:"Queremos informarle que su registro en BioUrbis ha sido completado con éxito",
